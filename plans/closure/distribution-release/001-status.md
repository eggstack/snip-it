# Release binary matrix and artifact contract — Closure Status
...
- `plans/archive/flat-001-release-binary-matrix-and-artifact-contract.md`
...
Primary class: capability. Dependencies: none (baseline).

## 1. Executive finding

M001 is closed. The five-target matrix, independent exact tags, and stable asset/checksum contract were established and consumed by installers and the release workflow.

## 2. Requirement-to-evidence matrix

| Requirement | Evidence | Result | Notes |
|---|---|---|---|
| Matrix, tags, asset names fixed | Implementation file + `plans/archive/flat-001-release-binary-matrix-and-artifact-contract.md` | pass | Pre-convention completion recorded in plans registry lineage. |
...
Pre-convention milestone: exact per-run command logs predate the closure template. Recorded evidence is the implementation file plus its `Status: complete` lineage and downstream consumption by M002/M004. No unresolved findings carried forward. No unresolved medium-or-higher finding remains.
