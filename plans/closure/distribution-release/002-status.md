# Binary-first bootstrap installers — Closure Status
...
- `plans/archive/flat-002-bootstrap-installers.md`
...
Primary class: capability. Dependencies: hard M001.

## 1. Executive finding

M002 is closed. Bash/PowerShell bootstrap installers ship verified-binary default with exact-version Cargo fallback, hard integrity failure, and no silent elevation.

## 2. Requirement-to-evidence matrix

| Requirement | Evidence | Result | Notes |
|---|---|---|---|
| Verified-binary default + Cargo fallback | Implementation file + archive pointer | pass | Deterministic installer failure-mode contracts covered. |
| State preservation | Implementation file | pass | Config/data/credentials preserved. |
...
Pre-convention milestone: evidence in the implementation file and archive pointer; `scripts/check.sh` plus production-seam checks green per the distribution lineage. No unresolved medium-or-higher finding remains.
