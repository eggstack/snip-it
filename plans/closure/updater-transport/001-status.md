# Binary-first self-update and restart integration — Closure Status
...
- `plans/archive/flat-004-binary-first-self-update.md`
...
M001 is closed. Binary-first self-update plus restart integration landed with verified-binary default, exact-version Cargo fallback, and hard integrity failure.

## 2. Requirement-to-evidence matrix

| Requirement | Evidence | Result | Notes |
|---|---|---|---|
| Binary-first update + restart | Implementation file + archive pointer | pass | Pre-convention completion recorded. |
