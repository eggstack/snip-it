> **Planning-convention migration note.** This file was promoted via `git mv` from pre-convention flat plan `015-snp-updater-end-to-end-timeout-corrective.md` (history preserved). Its body is unchanged historical evidence.
> New-convention identity: Updater Transport M003 — snp updater end-to-end timeout corrective.
> Source roadmap: `plans/subsystems/updater-transport-roadmap.md` (M003).
...
> Status vocabulary mapping: pre-convention `Status: complete` means `closed` with closure record at `plans/closure/updater-transport/003-status.md`.
> Pre-convention archive pointer: `plans/archive/flat-015-snp-updater-end-to-end-timeout-corrective.md`.
